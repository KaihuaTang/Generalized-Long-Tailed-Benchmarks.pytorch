...
class train_center_ride():
    ...
    def run(self):
        # Start Training
        self.logger.info('=====> Start Center Loss with RIDE backbone Training')
        ...
        for epoch in range(num_epoch):
            ...
            for step, ((inputs1, labels1, _, indexs1), (inputs2, labels2, _, indexs2)) in enumerate(zip(env1_loader, env2_loader)):
                ...
                loss_ct = self.loss_center(features.view(features.shape[0], -1), labels) * center_weight
